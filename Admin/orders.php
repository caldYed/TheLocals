...
img.customer-img, img.product-img { width:50px; height:50px; object-fit:cover; border-radius:50%; }
...
if(count($order['items']) > 0){
    ...
    foreach($order['items'] as $item){
        ...
        echo htmlspecialchars($item['name'])." × ".$item['quantity']." (₱".number_format($item['subtotal'],2).")";
        echo "</li>";
    }
    echo "</ul>";
} else {
