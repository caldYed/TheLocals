...
<title>Preorders History | Admin</title>
<style>
...
a.button { display:inline-block; margin-bottom:20px; padding:10px 20px; background:#007bff; color:white; text-decoration:none; border-radius:6px; }
...
img.product-img { width:50px; height:50px; object-fit:cover; border-radius:6px; }
</style>
</head>
<body>
<div class="container">
<h1>Preorders History</h1>

<a href="index.php" class="button">Back to Dashboard</a>

<?php
// Fetch all delivered preorders
$sql = "SELECT * FROM preorders WHERE status='Delivered' ORDER BY created_at DESC";
...
<td><?php echo $preorder['rider_id'] ?? 'N/A'; ?></td>
...
<?php else: ?>
<p>No previous preorders found.</p>
<?php endif; ?>
